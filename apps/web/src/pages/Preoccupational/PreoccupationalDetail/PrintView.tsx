...
export default function PrintView({ exam, onReady }: Props) {
  ...
  return (
    <>
      ...
      {/* Standalone header strip — captured by handlePrint for sworn declaration attachment pages */}
      ...
      {/* â”€â”€â”€ PAGE 2: Declaración Jurada â”€â”€â”€ */}
      <div className="pv-page" data-pv-page="declaration" style={pageStyle}>
        ...
        <div style={{ display: 'flex', gap: 32, marginBottom: 8, flexWrap: 'wrap' }}>
          <span style={{ fontSize: '9.5pt' }}><strong>¿Fuma?</strong> {cb(habitsDeclaration.smokes)}</span>
          <span style={{ fontSize: '9.5pt' }}><strong>¿Bebe alcohol?</strong> {cb(habitsDeclaration.drinks)}</span>
          <span style={{ fontSize: '9.5pt' }}><strong>¿Drogas?</strong> {cb(habitsDeclaration.drugs ?? false)}</span>
          {habitsDeclaration.drugs && habitsDeclaration.drugsDetail && (
            <span style={{ fontSize: '9.5pt' }}>Detalle: {habitsDeclaration.drugsDetail}</span>
          )}
        </div>
      ...
      {/* â”€â”€â”€ PAGE 3: Antecedentes Personales + Examen Clínico â”€â”€â”€ */}
      <div className="pv-page" style={pageStyle}>
        <PageHeader logoSrc={logoDataUrl} />
        <div style={{ flexGrow: 1 }}>
      ...
      {/* â”€â”€â”€ PAGE 4: Espirometría â”€â”€â”€ */}
      ...
      {/* â”€â”€â”€ PAGE 5: Examen Radiográfico + Examen Final â”€â”€â”€ */}
      ...
      {/* â”€â”€â”€ PAGE 6: Resultado + Conclusión â”€â”€â”€ */}
